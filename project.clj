(defproject aoc-clj "0.1.0-SNAPSHOT"
  ...
  :source-paths ["src" "components/util/src" "components/binary/src" "components/digest/src"]
  :test-paths   ["test" "components/util/test" "components/binary/test" "components/digest/test"]
