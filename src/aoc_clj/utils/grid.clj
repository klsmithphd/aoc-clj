...
(defprotocol Grid2D
  ...
  (positions [this] "A sequence of all of the grid positions")
  (values [this] "A sequence of the values at each of the grid positions, in the same order as `positions`")
