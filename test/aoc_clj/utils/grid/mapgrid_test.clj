(ns aoc-clj.utils.grid.mapgrid-test
  (:require [clojure.test :refer [deftest testing is]]
            [aoc-clj.utils.grid :as grid :refer
             [width height orientation value pos-seq val-seq slice neighbors-4 neighbors-8]]
            [aoc-clj.utils.grid.mapgrid :as mg :refer [->MapGrid2D]]))

(def sample
  (->MapGrid2D 3 2 :y-down {[0 0] 1 [1 0] 2 [2 0] 3
                            [0 1] 4 [1 1] 5 [2 1] 6}))
