(ns aoc-clj.year-2023.interface
  ...
  (:require [aoc-clj.year-2023.day01 :as d01]
            [aoc-clj.year-2023.day02 :as d02]
            [aoc-clj.year-2023.day03 :as d03]
            [aoc-clj.year-2023.day04 :as d04]
            [aoc-clj.year-2023.day06 :as d06]
            [aoc-clj.year-2023.day07 :as d07]
            [aoc-clj.year-2023.day08 :as d08]
            [aoc-clj.year-2023.day09 :as d09]
            [aoc-clj.year-2023.day10 :as d10]
            [aoc-clj.year-2023.day11 :as d11]
            [aoc-clj.year-2023.day12 :as d12]
            [aoc-clj.year-2023.day13 :as d13]
            [aoc-clj.year-2023.day15 :as d15]
            [aoc-clj.year-2023.day16 :as d16]
            [aoc-clj.year-2023.day18 :as d18]
            [aoc-clj.year-2023.day19 :as d19]
            [aoc-clj.year-2023.day20 :as d20]
            [aoc-clj.year-2023.day21 :as d21]
            [aoc-clj.year-2023.day22 :as d22]
            [aoc-clj.year-2023.day23 :as d23]
            [aoc-clj.year-2023.day24 :as d24]
            [aoc-clj.year-2023.day25 :as d25]))
...
(def solutions
  {1  {:parse #'d01/parse :part1 #'d01/part1 :part2 #'d01/part2}
   ...
   21 {:parse #'d21/parse :part1 #'d21/part1}
