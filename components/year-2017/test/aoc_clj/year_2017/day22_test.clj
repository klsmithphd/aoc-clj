(ns aoc-clj.year-2017.day22-test
...
(deftest infections-caused-at-n-test
  (testing "Counts how many infections were caused after n bursts"
    (is (= 5 (d22/infections-caused-at-n :part1 d22-s00 7)))
    (is (= 41 (d22/infections-caused-at-n :part1 d22-s00 70)))
    (is (= 5587 (d22/infections-caused-at-n :part1 d22-s00 d22/burst-count-p1)))

    (is (= 1 (d22/infections-caused-at-n :part2 d22-s00 7)))
    (is (= 26 (d22/infections-caused-at-n :part2 d22-s00 100)))))

(deftest ^:slow infections-caused-at-n-p2-test
  (testing "Counts how many infections were caused after n bursts"
    (is (= 2511944
           (d22/infections-caused-at-n :part2 d22-s00 d22/burst-count-p2)))))
